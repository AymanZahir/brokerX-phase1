...
2. Le dashboard `BrokerX Golden Signals` est auto-provisionné depuis `docs/phase2/observability/grafana-golden-signals.json` et la datasource Prometheus (`http://prometheus:9090`) est préconfigurée.
